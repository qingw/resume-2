...
\begin{myeducations}
  ...
  \myeducation
    ...
    [计算机科学与信息技术学院]
    {计算机科学与技术}%
    {学士 \textbullet 曹峰教授 \textbullet 数据挖掘}%
\end{myeducations}
...
\begin{experiences}
  \experience
    {2019.09}%
    [2019.07]%
    {\link{https://www.webank.com/}{深圳前海微众银行股份有限公司}}%
    {分布式商业科技发展部}%
    [区块链技术岗(深圳)]%
    [\begin{itemize}
      \item{\icon{\faCheck}} 调研了hyperledger在选择披露中的工作，code review了hyperledger-indy项目
      \item{\icon{\faCheck}} 实现了DPKI体系中的证书撤销功能，并开发了相关组件 \githublinks{HaoXuan40404}{indy-crypto/tree/accumulator}
      \item{\icon{\faCheck}} \myzhuanli    {《一种区块链中支持事件搜索的方法》}    {第一作者}
    \end{itemize}]%
...
\begin{myresearchs}
  \myresearch
    ...
    {\textbf{\link{https://esorics2019.uni.lu/cfp/}{ESORICS 2019 （CCF/CACR B类会议）}}}
    {\textbf{Accepted}}
    {\textbf{第一作者}}%
